  ...
  return (
    <>
      ...
      >
        ...
        <div
          className={`grid grid-rows-5 absolute px-7 w-full mb-7 pt-3 transition-all duration-500 bg-white ${
        ...
        >
          ...
          <h5
            ...
            className="text-base row-span-1 cursor-pointer hover:text-orange-600 text-gray-500"
          >
            {author.name}
          </h5>
...
export const NewReleasesCardSkeleton = () => {
  return (
