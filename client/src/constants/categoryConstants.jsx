...
export const ALL_CATEGORIES_PAGINATION_REQUEST =
  'ALL_CATEGORIES_PAGINATION_REQUEST';
export const ALL_CATEGORIES_PAGINATION_SUCCESS =
  'ALL_CATEGORIES_PAGINATION_SUCCESS';
export const ALL_CATEGORIES_PAGINATION_FAIL = 'ALL_CATEGORIES_PAGINATION_FAIL';
